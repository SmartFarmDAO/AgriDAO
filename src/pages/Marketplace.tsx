      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="browse" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="mylistings" onClick={() => navigate('/farmer-onboarding')}>My Listings</TabsTrigger>
            <TabsTrigger value="orders" onClick={() => navigate('/orders')}>Orders</TabsTrigger>
          </TabsList>
