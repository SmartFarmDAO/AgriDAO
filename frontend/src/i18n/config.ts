...
export const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    home: {
      hero: 'Empoderando a los agricultores a través de Blockchain',
      subtitle: 'Mercado directo que conecta agricultores con compradores',
      getStarted: 'Comenzar',
      learnMore: 'Saber más',
    },
    products: {
  ...
  fr: {
    ...
    home: {
      hero: 'Autonomiser les agriculteurs grâce à la Blockchain',
      subtitle: 'Marché direct reliant les agriculteurs aux acheteurs',
